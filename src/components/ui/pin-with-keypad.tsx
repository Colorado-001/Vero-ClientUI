...
export const PinInputWithKeypad = React.forwardRef<PinInputRef, Props>(
  (
    {
      length = 6,
      onComplete,
...
PinInputWithKeypad.displayName = "PinInputWithKeypad";
...
const KeypadKey: React.FC<{
...
}> = ({ label, onPress, variant = "primary", className }) => {
  ...
  return (
    <motion.button
      ...
      type="button"
      className={cn(
        `h-[80px] w-[80px] rounded-full flex items-center justify-center text-[28px] font-medium transition ${
          isSecondary
